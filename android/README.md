...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordrhymes-api:1.1.14'
}
```
...
```java
import com.apiverve.wordrhymes.RhymingWordsAPIClient;
import com.apiverve.wordrhymes.APIResponse;
import com.apiverve.wordrhymes.APIException;

// Initialize the client
RhymingWordsAPIClient client = new RhymingWordsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "blue");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordrhymes](https://docs.apiverve.com/ref/wordrhymes)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordrhymes](https://docs.apiverve.com/ref/wordrhymes)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordrhymes-api/issues)
