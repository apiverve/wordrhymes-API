...
namespace APIVerve.API.RhymingWords
{
    ...
    /// <summary>
    /// Client for the RhymingWords API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "limit", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 100 } }
        };
        ...
        private void ValidateParams(RhymingWordsQueryOptions options)
        {
