...
class wordrhymesWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/wordrhymes');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/wordrhymes';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"word":{"type":"string","required":true},"limit":{"type":"integer","required":false,"min":1,"max":100,"default":10}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/wordrhymes`);
        }
    }
...
module.exports = wordrhymesWrapper;
