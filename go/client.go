// Package wordrhymes provides a Go client for the Rhyming Words API.
//
// For more information, visit: https://wordrhymes.apiverve.com?utm_source=go&utm_medium=readme
package wordrhymes
...
const (
	baseURL        = "https://api.apiverve.com/v1/wordrhymes"
	defaultTimeout = 30 * time.Second
)

// Client is the Rhyming Words API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Rhyming Words API client.
...
// Execute makes a request to the Rhyming Words API with typed parameters.
//
...
//   - word (required): string - The word for which you want to get rhyming words
//   - limit: integer - Limit the number of word rhymes returned [min: 1, max: 100]
